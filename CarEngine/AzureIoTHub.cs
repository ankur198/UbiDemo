...
class AzureIoTHub
{
    ...
    //
    // Note: this connection string is specific to the device "raspi2". To configure other devices,
    // see information on iothub-explorer at http://aka.ms/iothubgetstartedVSCS
    //
    const string deviceConnectionString = "HostName=Home198.azure-devices.net;DeviceId=raspi2;SharedAccessKey=DAIs3te/fLbVviWfzNoIG1Ccs+gb72+m5KHsDdsXkUQ=";


    //
    // To monitor messages sent to device "kraaa" use iothub-explorer as follows:
    //    iothub-explorer monitor-events --login HostName=Home198.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=WO4klPRGoqldD4IudJCSOYQntRBm5444oh/7FNu/VTs= "raspi2"
    //
    ...
    public static async Task SendDeviceToCloudMessageAsync()
    {
        CreateClient();
#if WINDOWS_UWP
        var str = "{\"deviceId\":\"raspi2\",\"messageId\":1,\"text\":\"Hello, Cloud from a UWP C# app!\"}";
#else
        var str = "{\"deviceId\":\"raspi2\",\"messageId\":1,\"text\":\"Hello, Cloud from a C# app!\"}";
#endif
