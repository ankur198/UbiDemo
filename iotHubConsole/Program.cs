...
namespace ConsoleSample
{
    class Program
    {
        ...
        private static string connectionString = "HostName=Home198.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=C0oGr02QT+Z2KHPrwrSuJJunVpPJZgE32kLfs6YHq1I=";

        const string deviceID = "HomePi";
        ...
        static async Task SendMessage()
        {
            ...
            Console.Write("Tubelight,");
            var str = "Tubelight," + Console.ReadLine();
